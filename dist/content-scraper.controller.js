...
let ContentScraperController = class ContentScraperController {
    ...
    async refresh() {
        return this.scraper.scrapeFiestaHouse();
    }
    async status() {
        return this.scraper.getStatus();
    }
    async assets(category) {
        return this.scraper.getAssets(category);
    }
};
...
], ContentScraperController.prototype, "refresh", null);
__decorate([
    (0, common_1.Get)('status'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ContentScraperController.prototype, "status", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ContentScraperController.prototype, "assets", null);
exports.ContentScraperController = ContentScraperController = __decorate([
    (0, common_1.Controller)('api/content-scraper'),
