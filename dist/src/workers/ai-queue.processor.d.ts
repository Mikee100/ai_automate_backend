...
export declare class AiQueueProcessor {
    ...
    constructor(aiService: AiService, messengerSendService: MessengerSendService, whatsappService: WhatsappService, instagramService: InstagramService, messagesService: MessagesService, customersService: CustomersService, websocketGateway: WebsocketGateway);
