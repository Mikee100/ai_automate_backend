...
export declare class WebhooksService {
    ...
    constructor(messagesService: MessagesService, customersService: CustomersService, aiService: AiService, messageQueue: Queue, websocketGateway: WebsocketGateway);
